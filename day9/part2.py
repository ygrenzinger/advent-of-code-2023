def calculate_previous_value(history):
    """Calculates the previous value of a given history sequence using the difference method."""
    ...
    # Calculate the previous value by working backwards from the zero sequence
...
next_values = [
    calculate_previous_value(history) for history in histories
]
